...
cd "$REPO_ROOT"
mkdir -p test/phase15/tmp
source "$TEST_VENV/bin/activate"
yaml2qemu tutorial/lesson15-distribution/src/board.yaml --out-dtb test/phase15/tmp/board.dtb

if [ ! -f test/phase15/tmp/board.dtb ]; then
